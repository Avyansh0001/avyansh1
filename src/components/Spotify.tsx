    ...
    <>
      <FadeIn>
        {doing?.listening_to_spotify ? (
          <>
            <div className="sticky bottom-0 flex sm:flex-row mb-8 space-x-0 sm:space-x-2 w-full mt-4">
              <img
              ...
              <div className="text-sm leading-tight">
                <div className="space-x-2 mt-3">
                  <div className="flex justify-between">
                    <span className="font-black text-black dark:text-white inline-flex space-x-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        className="fill-current text-black dark:text-white rounded-2xl w-4 h-4"
                      >
                        <rect
                  ...
                  <span className="text-black dark:text-white space-x-2">
                    <a
