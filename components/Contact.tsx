    ...
    <div className="w-full max-w-2xl mx-auto">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="inline-flex items-center justify-center mb-1">
          <button
            aria-label="Submit"
            className="inline-block px-5 py-2 m-0 font-semibold text-gray-50 transition rounded-md bg-gray-900 hover:bg-gray-800 dark:bg-warmGray-200 dark:text-gray-900 dark:hover:bg-gray-400 duration-150 dark:text-white"
          >
