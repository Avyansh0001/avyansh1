    ...
    <div className="w-full max-w-2xl mx-auto">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="inline-flex items-center justify-center mb-1">
          <button
            aria-label="Submit"
            className="inline-block px-5 py-2 m-0 font-semibold text-gray-50 transition rounded-md bg-opacity-50 bg-purple-300 hover:bg-purple-500 duration-150 dark:text-white"
          >
