...
import { Items } from "../types/Github";
...
const Index = () => {
  ...
  const { data } = useSWR<Items>(`/api/github`, fetcher);
  return (
    <Main
      meta={
        <Meta
    ...
    >
      <div className="flex-col items-center md:mx-0 mx-2">
        <Profile />
        <div className="md:mt-0 mt-1 sm:mt-8">
          ...
          <div className="mb-8">
            <p className="mb-4 bg-clip-text bg-gradient-to-tl from-gray-700 via-gray-900 to-black dark:bg-gradient-to-tl dark:from-gray-50 dark:via-gray-100 dark:to-white">
              A 13 year old web developer, graphic designer and crypto currency enthusiast...
              <span>&#129488;</span>
            </p>
          </div>
        </div>
      ...
      <div className="md:mx-0 mx-2">
        ...
        <div className="items-center bg-gray-200 dark:bg-red-900 bg-opacity-20 dark:bg-opacity-20 md:bg-transparent rounded-2xl p-4 w-full motion-safe:animate-wiggle hidden">
          <div className="grid items-center justify-center">
            <div className="flex space-x-2">
              ...
              <p className="mt-0.5">
                <span className="font-bold">Note:</span> Repository Github is
                disabled for now. You can see my repository from this link below
                <a
        ...
        <div className="flex flex-col items-start justify-center max-w-2xl mx-auto">
          <h1 className="mb-3 text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-t from-coolGray-900 to-warmGray-600 dark:bg-gradient-to-l dark:from-coolGray-100 dark:to-coolGray-300">
            Repository Github
          </h1>
          <div className="mb-8">
          ...
          <div className="flex flex-col w-full overflow-y-scroll h-96 overflow-x-hidden">
            <div className="grid w-full grid-cols-1 gap-4 my-2 sm:grid-cols-2">
              {data ? (
                ...
                <div className="w-full justify-center overflow-hidden transition transform metric-card max-w-72 hover:scale-95 bg-gray-100 dark:bg-gray-900 bg-opacity-50 dark:bg-opacity-50 md:bg-opacity-100 rounded-2xl p-4">
                  <p className="bg-clip-text bg-gradient-to-tl from-gray-700 via-gray-900 to-black dark:bg-gradient-to-tl dark:from-gray-50 dark:via-gray-100 dark:to-white animate-pulse"></p>
                  <div className="flex items-center text-gray-900 dark:text-gray-100 animate-pulse space-x-1 mt-1">
                    <svg
                      className="animate-spin h-5 w-5 text-gray-900 dark:text-gray-100"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                  ...
                  <p className="mt-2 text-sm font-medium text-gray-800 spacing-sm dark:text-white animate-pulse"></p>
                </div>
              )}
            </div>
          </div>
